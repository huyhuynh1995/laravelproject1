    ...
    <div class="col-md-12">
    	<div class="card">
    		<div class="card-header">
    			<h3> Thêm Sản phẩm <a href="{{ url('admin/products') }}" class="btn btn-danger btn-sm text-white float-end">Tất cả sản phẩm</a></h3>
    		</div>
    		<div class="card-body">
                @if($errors->any())
                ...
                <form action="{{ url('admin/products')}}" method="POST" enctype="multipart/form-data">
                   ...
                   <ul class="nav nav-tabs" id="myTab" role="tablist">
                      ...
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="color-tab" data-bs-toggle="tab" data-bs-target="#color-tab-pane" type="button" role="tab" aria-controls="image-tab-pane" aria-selected="false" >Màu sắc</button>
                      </li>
                    </ul>
                          ...
                          <div class="row">
                               ...
                               <div class="col-md-4">
                                   <div class="mb-3">
                                       ...
                                       <input type="checkbox"  name="trending" >: (Checked = "sản phẩm trend", Không Check = "sp bình thường")
                                   </div>
                               </div>
                               <div class="col-md-4">
                                   <div class="mb-3">
                                       <label for="">Featured</label>
                                       <input type="checkbox"  name="featured" >: (Checked = "sản phẩm đặc biệt", Không Check = "sp bình thường")
                                   </div>
                               </div>
                               <div class="col-md-4">
                                   <div class="mb-3">
                                       <label for="">Status</label>
                                       <input type="checkbox"  name="status"  > : (Checked = "tạm dừng bán", Không Check = "Kích hoạt")
                                   </div>
                               </div>  
                           </div>
                      </div>
