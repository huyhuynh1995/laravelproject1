                        ...
                        @forelse($brands as $brand)
                           <tr>
                               ...
                               <td>
                                   ...
                                   <a href="#" wire:click="deleteBrand({{ $brand->id }})" data-bs-toggle="modal" data-bs-target="#deleteBrandModal" class="btn btn-danger">Xóa</a>
                               </td>
                           </tr>
                           @empty
                           <tr>
                               <td colspan="5">Không có brand nào được tìm thấy</td>
                           </tr>
                        @endforelse   
                       </tbody>
                   </table>
